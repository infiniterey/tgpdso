...
<div id="sidebar-menu" name="sidebar-menu" class="main_menu_side hidden-print main_menu">
  <div class="menu_section">
    ...
    <ul class="nav side-menu">
      ...
      <li><a href="records.php" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-list-alt"></i> Records <span class="fa fa-chevron-down"></span></a></li>
      ...
      <li><a href="add_production.php"><i style="color: red;"class="fa fa-folder-open"></i> Add Production </a></li>
    </ul>
  </div>
</div>
