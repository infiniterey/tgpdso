	...
	<form method="post">
        ...
        <!-- page content -->
		  		...
		  		<div class="clearfix">
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								<div class="x_panel">
									<div class="x_title">
										<h2><b>Daily Production Report</b></h2>
              ...
              <div style="margin-left: 760px; margin-top: -70px;">
                ...
                <div style="margin-left: 10px"><b>Month</b></div>
                <select id="inputMonth" name="inputMonth" class="form-control" style="width: 180px;margin-left: 10px">
                ...
                <div style="margin-left: 40px;">
                  <h5><b>Daily Production Report of (Month)</b></h5>
                </div>
                <div style="overflow-x: auto; width: 900px; margin-left: 40px; border-style: solid; border-width: 1px;" class="scrollpage">
                  ...
                  <table style="width: 1600px;" id="dataTable1" name="dataTable1" class="table table-bordered table-hover no-footer" role="grid">
                    <thead>
                      <tr role="row">
                        <th class="sorting_asc" style="width: 50px;text-align:center;">Transaction Date.</th>
                        <th class="sorting" style="width: 25px;text-align:center;">Name of Insured</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Policy No.</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Plan</th>
                        <th class="sorting" style="width: 50px;text-align:center;">OR No.</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Premium</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Mode of Payment</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Issued Date</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Agent Name</th>
                        <th class="sorting" style="width: 50px;text-align:center;">Remarks</th>
                    </thead>
                    <tbody>
                      <tr>
                                <td></td>
