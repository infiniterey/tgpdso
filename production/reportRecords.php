						...
						<div class="row">
							<div class="col-md-12 col-sm-12 col-xs-12">
								...
								<script>
									...
									{
										$("#printContent1").load("reportRecords.php");
									}
								</script>
								<button type="button" id="printPreview" name="printPreview" class="btn btn-primary" onclick="previewSample()">Preview Print</button>
										...
										sampleSample sampleSample sampleSample sampleSample sampleSample sampleSample<br>
										 ...
										 <div style="margin-top: 50px;">
												...
												<tr role="row">
														...
														<th class="sorting" tabindex="0" aria-controls="datatable-fixed-header1" rowspan="1" colspan="1" aria-label="Remarks: activate to sort column ascending" style="width: 30px;text-align:center;">Policy No.</th>
